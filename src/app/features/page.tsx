...
export const metadata: Metadata = buildMetadata({
  title: "Nautix Features | Omnichannel AI Operations Platform",
  description:
    "Explore Nautix features for shared inbox, AI agents, campaign automation, analytics, and cross-channel customer operations.",
  path: "/features",
  keywords: [
    "nautix features",
...
const featuresBreadcrumbSchema = buildBreadcrumbSchema([
  { name: "Home", path: "/" },
  { name: "Features", path: "/features" },
]);

const featuresSoftwareSchema = buildSoftwareApplicationSchema({
  name: "Nautix Platform Features",
  description:
    "Nautix combines shared inbox, AI agents, campaign automation, and analytics for customer operations across WhatsApp, Instagram, and Facebook.",
  path: "/features",
});
...
export default function Features() {
  return (
    <>
      <JsonLd data={featuresBreadcrumbSchema} />
      <JsonLd data={featuresSoftwareSchema} />
